...
//ダイレクトアクセス禁止
require(ROOT_PATH .'/Models/Main/Staff/Resist/Ban_confirm.php');

//画像取り込み
require(ROOT_PATH .'/Models/Main/Staff/Resist/Image.php');

//モデルコントローラー
require_once(ROOT_PATH .'/Controllers/Main/ResistControllers.php');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST'){
  // メール送信機能
  require_once(ROOT_PATH .'/Models/Main/Staff/Resist/Send.php');
  //登録機能
...
<head>
    ...
    <link rel="stylesheet" href="/css/Main/Staff/confirm.css">
...
<body>
         ...
         <form action="" method="POST" novalidate>
           ...
           <div id="main-box">
             ...
             <div class="input-box">
              ...
              <h3 class="post" >
                <?php
                require(ROOT_PATH .'/Models/Main/Staff/Resist/Select.php');
                ConfirmInst();
                ?>
              </h3>
             </div>
    ...
    <script src="/js/Main/resist.js"></script>
</body>
</html>