...
require_once(ROOT_PATH .'/Models/Main/Staff/Edit/Image.php');

// //バリデーション取得
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  require_once(ROOT_PATH .'/Models/Main/Staff/Edit/Validation.php');
...
<head>
    ...
    <link rel="stylesheet" href="/css/Main/Staff/edit.css">
    ...
    <main>
        ...
        <form action="" method="POST" enctype="multipart/form-data" novalidate>
             ...
             <div class="input-box">
              ...
              value="<?= h($instructor['name']);?>"required>
             </div>
             ...
             <div class="input-box">
              ...
              value="<?= h($instructor['kana']);?>"required>
             </div>
             ...
             <div class="input-box">
              ...
              value="<?= h($instructor['tel']);?>"required>
             </div>
             ...
             <div class="input-box">
              ...
              value="<?= h($instructor['code']);?>"required　>
             </div>
             ...
             <div class="input-box">
              ...
              <select class="text-box" name="inst" id="">
                <?php
                 require_once(ROOT_PATH .'/Models/Main/Staff/Edit/Select.php');
                 DefaultInst();
                 SelectInst();
                ?>
              </select>
             ...
             <div id="etc-box">
              <p id="etc-name" >経歴：</p>
              <textarea name="body" id="etc" required><?= h($instructor['body']);?></textarea>
             </div>
